...
# stripe
if env('DEBUG'):
    DEBUG_STRIPE_PUBLIC_KEY = env('DEBUG_STRIPE_PUBLIC_KEY')
    DEBUG_STRIPE_SECRET_KEY = env('DEBUG_STRIPE_SECRET_KEY')
    DEBUG_STRIPE_WEBHOOK_SECRET = env('DEBUG_STRIPE_WEBHOOK_SECRET')
else:
